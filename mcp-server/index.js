...
async function getServer() {
 ...
 console.log(`Connected to MySQL database ${process.env.DB_DATABASE} at ${process.env.DB_HOST}:${process.env.DB_PORT}`);
  ...
  server.registerResource(
    ...
    async (uri) => {
      try {
        ...
        return { contents: [{ uri: uri.href, text: `Error: ${err.message}` }] };
      }
    }
  );
