...
@section('content')
    <booked-castings-page></booked-castings-page>
@endsection
...
@section('scripts')
    ...
    <!-- COMPONENTS -->
    <script type="text/javascript" src="{{ '/assets/components/talentCasting/bookedCastingsPage.component.js?v='. config('view.assets.version') }}"></script>
