...
@section('content')
    <callback-castings-page></callback-castings-page>
...
@section('scripts')
    ...
    <!-- COMPONENTS -->
    <script type="text/javascript" src="{{ '/assets/components/talentCasting/callbackCastingsPage.component.js?v='. config('view.assets.version') }}"></script>
