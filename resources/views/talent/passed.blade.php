...
@section('content')
    <passed-castings-page></passed-castings-page>
@endsection
...
@section('scripts')
    ...
    <!-- COMPONENTS -->
    <script type="text/javascript" src="{{ '/assets/components/talentCasting/passedCastingsPage.component.js?v='. config('view.assets.version') }}"></script>
