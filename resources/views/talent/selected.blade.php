...
@section('content')
    <selected-castings-page></selected-castings-page>
@endsection
...
@section('scripts')
    ...
    <!-- COMPONENTS -->
    <script type="text/javascript" src="{{ '/assets/components/talentCasting/selectedCastingsPage.component.js?v='. config('view.assets.version') }}"></script>
